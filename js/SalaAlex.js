...
function preload() {
    ...
    this.load.image('tiles', 'assets/PC Computer - The Binding of Isaac Rebirth - Cellar.png');
    this.load.tilemapTiledJSON('cellar', 'assets/Cellar-0606.json');
...
function create() {
    ...
    const map = this.make.tilemap({ key: "cellar", tileWidth: 52, tileHeight: 52 });
    const tileset = map.addTilesetImage('cellar', 'tiles');
